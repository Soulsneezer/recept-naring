        ...
        {this.state.myAlternative === 'Titel'? 
          ...
          <Container className="container-outer">
            ...
            <Button 
              ...
              {this.state.recipesLength <= this.state.countRecipe ? 'Inga fler recept': 'Visa fler recept'}
            </Button>
          </Container>
          :
          ...
          <Container className="container-outer">
            ...
            <Button 
              ...
              {this.state.recipesCategorysLength <= this.state.countCategory ? 'Inga fler recept': 'Visa fler recept'}
            </Button>
          </Container>
        }
      </div>
