    ...
    return(
      <React.Fragment>
      	<footer className="container-fluid bg-light mt-5 footer-component">
              ...
              <a href="http://googlemaps.com" className="d-inline-block align-top pt-2 pr-2 ">
								<img src={placeholder} className="icon" alt="map-tag icon"></img>
							</a>
              <p className="d-inline-block">1355 Market St, Suite 900 <br/> San Fransisco, CA 94103</p>
              <div className="d-sm-none">
                <a href="http://eniro.se" className="d-inline-block align-top pt-2 pr-4">
									<img src={contact} className="icon" alt="phone and letter icon"></img>
								</a>                       
            ...
            <div className="col-8 col-sm-5 p-2 d-none d-sm-block box">
              <a href="http://eniro.se" className="d-inline-block align-top pt-2 pr-3">
								<img src={contact} className="icon" alt="phone and letter icon"></img>
							</a>                       
