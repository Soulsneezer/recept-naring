                ...
                <div className="row ">
                    ...
                    <div className="col-8 col-sm-5 p-2 box">
                        ...
                        <div className="d-sm-none">
                            <a href="http://eniro.se" className="d-inline-block align-top pt-2 pr-4"><img src={contact} className="icon" alt="-Logo"></img></a>
                    ...
                    <div className="col-4 col-sm-2 mt-3 pl-5 pl-sm-0 box ">
                        <div className="icons" >
                            <a href="http://facebook.com"><img src={facebook} className="icon" alt="facebook-Logo"></img></a>
                            <a href="http://twitter.com"><img src={twitter} className="icon" alt="twitter-Logo"></img></a>
                            <a href="http://instagram.com"><img src={instagram} className="icon" alt="instagram-Logo"></img></a>
                        </div>
                    </div>

                    <div className="col-8 col-sm-5 p-2 d-none d-sm-block box">
                        <a href="http://eniro.se" className="d-inline-block align-top pt-2 pr-3"><img src={contact} className="icon" alt="-Logo"></img></a>
